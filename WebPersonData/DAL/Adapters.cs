...
namespace DAL
{
    ...
    public class adapterPhones : DAL.dsCommonsTableAdapters.adapterPhones
    {
        public adapterPhones()
        {
            Connection.ConnectionString =  Properties.Settings.Default.WebPersonDataConnectionString;
        }

    }
    public class adapterEmails : DAL.dsCommonsTableAdapters.adapterEmails
    {
        public adapterEmails()
        {
            Connection.ConnectionString =  Properties.Settings.Default.WebPersonDataConnectionString;
        }
